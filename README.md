...
### ☠ 개발하며 느낀점 
----
아직 시멘틱한 태그 사용조차 미숙하다고 느꼈다. 클래스 네이밍도 어려웠고, CSS 작성시 요소들을 정렬하는것과 margin과 padding 값  
설정하는것을 아직 완전히 이해하지못해 적용하는데 시간이 오래걸렸다. 반응형 웹 구현도 해당 파트에 대한 이해도가 너무 낮아 구현하지 못했다.  
